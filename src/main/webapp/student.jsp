...
<form action="student-form" method="post">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-4">
            <input type="text" name="email" id="email" class="form-control"value="${param.email}"></div>
        <%
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-4">
            <input type="text" name="semester" id="semester" class="form-control"value="${param.semester}"></div>
        <%
